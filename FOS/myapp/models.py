...
class candidate(models.Model):
    elections = models.ForeignKey(elections, on_delete=models.CASCADE, default=1, related_name='candidates')
    candidatename = models.CharField(max_length=50, default='', blank=True)
    image = models.ImageField(upload_to='uploads/candidate/')
...
class votes(models.Model):
    ...
    user = models.ForeignKey(sup, on_delete=models.CASCADE)
